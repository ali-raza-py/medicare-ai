...
def _remove_temp_file(path: str | None) -> None:
    if path:
        try:
            ...
            # OCR libraries can retain a native file handle briefly on Windows.
            # A locked temp file is not a document resource and must not turn a
            # successful upload into a 500 response.
            pass
